...
| `eval` | 14 | 10 | 3.361 | Runner đo baseline / PEFT và so sánh hai lần chạy |
| `graph` | 16 | 16 | 2.096 | LangGraph: state, các node agent, và tool thực thi |
...
| `tests` | 41 | 38 | 9.047 | pytest — unit theo từng agent, integration theo độ phức tạp câu hỏi |
